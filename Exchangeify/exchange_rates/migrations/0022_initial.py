...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("exchange_rates", "0021_remove_currency_prices_currency_and_more"),
    ]
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        default=datetime.datetime(2023, 12, 8, 4, 20, 58, 353144)
                    ),
                ),
                (
                    "currency",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_at",
                    models.DateTimeField(
                        default=datetime.datetime(2023, 12, 8, 4, 20, 58, 355145)
                    ),
                ),
                (
                    "currency",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_at",
                    models.DateTimeField(
                        default=datetime.datetime(2023, 12, 8, 4, 20, 58, 351146)
                    ),
                ),
                (
                    "currency",
