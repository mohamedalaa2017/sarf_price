...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("exchange_rates", "0016_remove_currency_prices_currency_and_more"),
    ]
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        default=datetime.datetime(2023, 12, 8, 0, 15, 37, 142603)
                    ),
                ),
                (
                    "currency",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_at",
                    models.DateTimeField(
                        default=datetime.datetime(2023, 12, 8, 0, 15, 37, 144601)
                    ),
                ),
                (
                    "currency",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_at",
                    models.DateTimeField(
                        default=datetime.datetime(2023, 12, 8, 0, 15, 37, 136598)
                    ),
                ),
                (
                    "currency",
